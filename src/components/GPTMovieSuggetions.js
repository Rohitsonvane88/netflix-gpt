...
const GPTMovieSuggetions = () => {
    ...
    return (
        <div className="relative z-10 mx-24 mt-6 rounded-xl
            ...
            <div className="flex flex-col px-6 py-4">
                ...
                <div className="flex gap-4 flex-wrap mt-4 scrollbar-hide h-[400px] overflow-scroll justify-center items-center">
